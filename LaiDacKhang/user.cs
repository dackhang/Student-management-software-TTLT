...
namespace QuanLySinhVien
{
    public partial class user : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                OpenConnection();
                string strsql = "select tk as [Tên Tài Khoản], mk as [Mật Khẩu] from users";
        ...
        private void Btn_them_Click_1(object sender, EventArgs e)
        {
            ...
            {
                OpenConnection();
                string s = "insert into users (tk, mk) values(@username, @password)";
        ...
        private void Btn_sua_Click(object sender, EventArgs e)
        {
            ...
            {
                OpenConnection();
                string strsql = "update users set mk = @password where tk = @username";
        ...
        private void Btn_xoa_Click(object sender, EventArgs e)
        {
            ...
            {
                OpenConnection();
                string strsql = "delete from users where tk = @username";
                SqlCommand cmd = new SqlCommand(strsql, myconn);
                cmd.Parameters.AddWithValue("@username", Tbx_ten.Text);
                cmd.ExecuteNonQuery();
