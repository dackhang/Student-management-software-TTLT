...
namespace QuanLySinhVien
{
    public partial class tk_khoa : Form
    {
        ...
        private void tk_khoa_Load(object sender, EventArgs e)
        {
            ...
            Cbx_timtheo.Items.Add("Mã Khoa");
            Cbx_timtheo.Items.Add("Tên Khoa");
        ...
        private void Btn_tim_Click(object sender, EventArgs e)
        {
            ...
            string filterColumn = "";
            if (Cbx_timtheo.SelectedItem.ToString() == "Mã Khoa")
            {
                filterColumn = "makhoa";
            }
            else if (Cbx_timtheo.SelectedItem.ToString() == "Tên Khoa")
            {
                filterColumn = "tenkhoa";
            }
