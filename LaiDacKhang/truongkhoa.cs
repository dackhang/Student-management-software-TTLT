...
namespace QuanLySinhVien
{
    public partial class truongkhoa : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                OpenConnection();
                string strsql = "select tk as [Tên Tài Khoản], mk as [Mật Khẩu] from truongkhoa";
                ...
                {
                    Dgv_truongkhoa.DataSource = dtset.Tables[0];
                }
                else
                {
        ...
        private void Btn_them_Click(object sender, EventArgs e)
        {
            ...
            {
                OpenConnection();
                string s = "insert into truongkhoa (tk, mk) values(@username, @password)";
        ...
        private void Btn_sua_Click(object sender, EventArgs e)
        {
            ...
            {
                OpenConnection();
                string strsql = "update truongkhoa set mk = @password where tk = @username";
        ...
        private void Btn_xoa_Click(object sender, EventArgs e)
        {
            ...
            {
                OpenConnection();
                string strsql = "delete from truongkhoa where tk = @username";
                SqlCommand cmd = new SqlCommand(strsql, myconn);
                cmd.Parameters.AddWithValue("@username", Tbx_ten.Text);
                cmd.ExecuteNonQuery();
